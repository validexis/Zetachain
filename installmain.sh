...
wget -O $HOME/.zetacored/config/genesis.json https://server-1.itrocket.net/mainnet/zetachain/genesis.json
wget -O $HOME/.zetacored/config/addrbook.json  https://server-1.itrocket.net/mainnet/zetachain/addrbook.json
